...
```sql
SQL> create or replace package online_shop
  is
    function get_nr_couriers_for_product (product_id in number) return number;
    function get_order_id_with_max_nr_products return number;
    function check_courier_delivered_product (courier_id in number, product  2  _id in number) return number;
    function convert_to_RON (crt_price in number, currency "provider".products_currency%type) return float;
    procedure get_most_expensive_order_of_courier ( courier_id in "courier".id%type, total_price out number);
  end;
  3  /  4    5    6    7    8    9  
...
SQL> create or replace package body online_shop
  is
  ...
...
<div style="text-align: center;">
  <img src="./images/tasks/task13-sol-p1.png">
</div>

<div style="text-align: center;">
  <img src="./images/tasks/task13-sol-p2.png">
</div>

<div style="text-align: center;">
  <img src="./images/tasks/task13-sol-p3.png">
</div>